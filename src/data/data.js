const players = [
    {name: 'aguero', club: 'Man City', country: 'Argentina'},
    {name: 'aubamayang', club: 'Arsenal', country: 'Gabon'},
    {name: 'benzema', club: 'Real Madrid', country: 'France'},
    {name: 'coutinho', club: 'Bayern Munchen', country: 'Brazil'},
    {name: 'de-brunyne', club: 'Man City', country: 'Belgium'},
    {name: 'dybala', club: 'Juventus', country: 'Argentina'},
    {name: 'kante', club: 'Chelsea', country: 'France'},
    {name: 'lacazette', club: 'Arsenal', country: 'France'},
    {name: 'mane', club: 'Liverpool', country: 'Senegal'},
